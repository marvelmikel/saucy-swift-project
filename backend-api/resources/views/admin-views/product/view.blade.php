            ...
            <div class="card-body">
                <div class="row align-items-md-center gx-md-5">
                    ...
                    <div class="col-4 pt-2">
                        ...
                        <span>
                            {{translate('available')}} {{translate('time')}} {{translate('starts')}} : {{date(config('time_format'), strtotime($product['available_time_starts']))}}
                        </span><br>
                        <span>
                            {{translate('available')}} {{translate('time')}} {{translate('ends')}} : {{date(config('time_format'), strtotime($product['available_time_ends']))}}
                        </span>
                        ...
                        @endforeach
                        <h4 class="border-bottom mt-2"> {{translate('Addons')}} </h4>
